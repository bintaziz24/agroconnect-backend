...
class ProduitSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $produits = [
            ...
            ['agriculteur_id'=>$agri1?->id,'ferme_id'=>$getFermeId($agri1),'categorie_id'=>$legumes,  'nom'=>'Gombo frais',       'prix'=>300,  'stock'=>40,  'unite'=>'kg',    'photo'=>'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400'],
            ...
            ['agriculteur_id'=>$agri5?->id,'ferme_id'=>$getFermeId($agri5),'categorie_id'=>$cereales, 'nom'=>'Arachides grillées','prix'=>700,  'stock'=>150, 'unite'=>'kg',    'photo'=>'https://images.unsplash.com/photo-1528751014936-863e6e7a319c?w=400'],
